...
const adminprefix = "-v";
const devs = ['409093271592370186','406066481613373450'];
client.on('message', message => {
...
client.on('message', message => { 
    ...
    .setFooter(`extrem bot`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
...
client.on('message', message => {
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/kCQJRcF")
